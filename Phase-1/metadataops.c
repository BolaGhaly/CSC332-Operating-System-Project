...
{
    // check if local pointer is assigned to NULL
    if (localPtr == NULL)
    {
...
Boolean getMetaData (char *fileName, OpCodeType **opCodeDataHead, char *endStateMsg)
{
    ...
    *opCodeDataHead = NULL;
    ...
    {
        printf("There is a failure in first op command\n");
...
Boolean isDigit (char testChar)
{
    ...
    // if it is between characters '0' - '9', return true
