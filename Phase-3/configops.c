                      ...
                      char *endStateMsg)
{
    ...
    *configData = tempData;
    ...
    if (tempData->cpuSchedCode != CPU_SCHED_FCFS_N_CODE && tempData->cpuSchedCode != CPU_SCHED_SJF_N_CODE)
    {
        copyString(endStateMsg, "Currently, only FCFS-N and SJF-N are supported");
        return False;
    }
